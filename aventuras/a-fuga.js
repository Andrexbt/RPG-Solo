...
Você sorri de volta, e, com uma pontada de culpa, começa a caminhar na direção indicada por ele.`,
    ...
    confronto: {
      ...
      contexto: [
        `Você força sua passagem em meio ao caos e pensa nas suas opções.
    ...
    movimentacaoNoite: {
      ...
      contexto: [
        `Em cima do telhado, a noite chega enquanto você observa a batalha pelas ruas terminar.
    ...
    noitePelasEmbarcacoes: {
      ...
      contexto: [
        `Atravessar o rio a nado já seria perigoso em condições normais e, em sua condição atual, seria virtualmente impossível.
