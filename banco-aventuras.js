    ...
    cenas: {
      ...
      inicio: {
        ...
        escolhas: [
          ...
          id: "1",
          texto: "Tentar atravessar pelos telhados. Uma pilha de caixas empilhadas próximas à parede chama a sua atenção, parecendo oferecer um caminho até o telhado. Com alguma sorte e habilidade, talvez ninguém o veja e você consiga andar pelhos telhado até alcançar uma pequena torre próxima à ponte.",
              ...
              etapas: {
                  ...
                  noTelhado: {
                      ...
                      resultados: {
                          ...
                          id: "noTelhadoEsp",
                          texto: "Esperar. Talvez o melhor seja esperar e tentar usar o conflito a seu favor.",
                          ...
                          id: "noTelhadoIr",
                          texto: "Continuar. Cada segundo se torna mais perigoso, e nada garante que sua fuga vá se tornar menos perigosa no meio de uma batalha.",
                ...
                resultados: {
                  sucesso: {
                    ...
                    fracasso: {
                      texto: "Os guardas identificam sua posição.",proximaEtapa: "saltoFinal"
                    }
                }
                  },
          ...
          {
          id: "2",
          texto: "Se misturar na multidão. Correndo o risco de ser reconhecido, você pode tentar seguir o fluxo do protesto e buscar uma alternativa de escapada.",
          proximaCena: "naMultidao"
          },

          {
          id: "3",
          texto: "Continuar se esgueirando pelos becos. Você pode continuar nas sombras, caminhando por vielas na busca de um caminho menos direto para sair da cidade, apesar de a chance de ser encontrado por um dos Lagartos de Bronze ser alta.",
          proximaCena: "nosBecos"
          },

          {
          id: "4",
          texto: "Enfrentar os guardas de frente. De um jeito ou de outro, tudo acaba aqui e agora. Talvez o seu embate honesto com os guardas o torne menos covarde aos olhos da população que você está deixando para trás. Talvez eles o ajudem, talvez o impeçam de fugir...",
          proximaCena: "batalha"
          },
      ...
      esperaNoTelhado: {
        ...
        escolhas: [
          ...
          teste: {
            nome:"Acrobacia",
            dificuldade:12,
            instrucao: "Faça um teste de Acrobacia. Role 1d20 e adicione seu modificador de Destreza.",
          ...
          {
          id: "2",
          texto: "Pular de um telhado para o outro devagar, apenas quando tiver certeza de que não está sendo observado.",
      ...
      saltoBemSucedido: {
        ...
        contexto: "Você salta no último instante e alcança o telhado seguinte. Os perseguidores ficam para trás por alguns segundos.",
      ...
      saltoFracassado: {
        ...
        titulo: "Salto bem-sucedido",
        contexto:  "Você não alcança completamente o outro telhado e se agarra à borda. Os perseguidores estão cada vez mais próximos.",
