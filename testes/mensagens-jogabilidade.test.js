...
assert.deepEqual(queda, {
  ...
  historicoDescricao:
    "A arma arremessada errou Guarda 1 e caiu na coluna 12, linha 8.",
});

const cravada = global.obterMensagemJogabilidade(
...
assert.equal(
  global.obterMensagemJogabilidade("combate.evento.inexistente"),
  null,
);
